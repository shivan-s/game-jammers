...
import { type GameJamWithUsers } from "../../server/trpc/router/users/types";
import Button from "../Button";
import ProfileAvatar from "../ProfileAvatar";
import Image from "next/image";
import { useState } from "react";
import Modal from "../Modal";
import GameJamForm from "../../pages/gamejams/_form";
...
const GameJamWidget = ({
  ...
  return (
    <>
          ...
          <div className="flex flex-col px-4 py-4">
            ...
            <div className="flex justify-between gap-2">
              <div className="text-xs text-neutral-200">
                ...
                {teams.reduce(
                  (acc, team) => acc + team.teamToUser.length,
                  0
                ) === 1
                  ? "participant"
                  : "participants"}
      ...
      >
        <GameJamForm gameJamId={id} setShowModal={setShowModal} />
      </Modal>
    </>
  );
};
